...
def valida_esporte(esporte):
    esportes = ["Atletismo", "Badminton", "Basquete", "Corrida", "Dança", "Futebol", "Futsal", "Ginástica", "Handeball",
                "Judô", "Natação", "Passeio", "Tênis de Campo", "Tênis de Mesa", "Torneio de Cheerleaders", "Vôlei",
                "Xadrez"]
    if esporte not in esportes:
        # raise ValidationError("Esporte inválido.")
        return False
